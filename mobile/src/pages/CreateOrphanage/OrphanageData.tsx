...
export default function OrphanageData() {
  ...
  async function handleSelecteImages() {
  ...
  return (
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TouchableOpacity style={styles.imagesInput} onPress={handleSelecteImages}>
      ...
      <View style={styles.switchContainer}>
        <Text style={styles.label}>¿Atendiende el fin de semana?</Text>
        <Switch
          thumbColor="#fff"
